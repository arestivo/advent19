...
reader.on('close', () => { 
  ...
  computer.input.push(...'NOT E T\n'.split('').map(c => c.charCodeAt(0)))
  computer.input.push(...'NOT H J\n'.split('').map(c => c.charCodeAt(0)))
  computer.input.push(...'AND T J\n'.split('').map(c => c.charCodeAt(0)))
  computer.input.push(...'NOT J J\n'.split('').map(c => c.charCodeAt(0)))
  computer.input.push(...'NOT C T\n'.split('').map(c => c.charCodeAt(0)))
  computer.input.push(...'AND T J\n'.split('').map(c => c.charCodeAt(0)))
  computer.input.push(...'NOT B T\n'.split('').map(c => c.charCodeAt(0)))
  computer.input.push(...'OR T J\n'.split('').map(c => c.charCodeAt(0)))
  computer.input.push(...'NOT A T\n'.split('').map(c => c.charCodeAt(0)))
  computer.input.push(...'OR T J\n'.split('').map(c => c.charCodeAt(0)))
  computer.input.push(...'AND D J\n'.split('').map(c => c.charCodeAt(0)))
  computer.input.push(...'RUN\n'.split('').map(c => c.charCodeAt(0)))
